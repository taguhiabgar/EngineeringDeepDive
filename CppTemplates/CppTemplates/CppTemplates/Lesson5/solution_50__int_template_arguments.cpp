...
template<
        ...
        typename... Types
         >
struct performance_evaluator_variadic_values
{
    static_assert( false,
            "General case of 'performance_evaluator_variadic_values' class template should"
            " not be instantiated." );
};
...
template<
        ...
        typename HeadType,
        typename... Types >
struct performance_evaluator_variadic_values< CONT, HeadType, Types... > {
    void measure_performance() {
        ...
        // Continue with remaining sizes :-)
        performance_evaluator_variadic_values< CONT, Types... > inner_evaluator;
        inner_evaluator.measure_performance();
    }
...
template<
        template< typename, int > class CONT>
struct performance_evaluator_variadic_values< CONT > {
    void measure_performance() {
...
template<
        ...
        typename... Types
         >
struct performance_evaluator_variadic_all
{
    static_assert( false,
            "General case of 'performance_evaluator_variadic_all' class template should"
            " not be instantiated." );
};
...
template<
        ...
        int... Sizes
         >
struct performance_evaluator_variadic_all_helper
{
    static_assert( false,
            "General case of 'performance_evaluator_variadic_all' class template should"
            " not be instantiated." );
